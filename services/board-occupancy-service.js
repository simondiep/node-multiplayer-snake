...
class BoardOccupancyService {
    constructor() {
        ...
        for (let column=0; column < this.maxColumn; column++) {
            ...
            for (let row=0; row < this.maxRow; row++) {
                ...
                if(column === 0 || row === 0 || column === this.maxColumn - 1 || row === this.maxRow - 1) {
    ...
    getUnoccupiedHorizontalCoordinates(requiredFreeLength) {
        for (let row=0; row < this.maxRow; row++) {
            let unoccupiedCoordinates = [];
            for (let column=0; column < this.maxColumn; column++) {
                let coordinateAttribute = this.board[column][row];
    ...
    getUnoccupiedVerticalCoordinates(requiredFreeLength) {
        for (let column=0; column < this.maxColumn; column++) {
            let unoccupiedCoordinates = [];
            for (let row=0; row < this.maxRow; row++) {
                let coordinateAttribute = this.board[column][row];
